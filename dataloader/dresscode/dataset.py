...
from dataloader.dresscode.labelmap import label_map
...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # parser_mask_fixed là những vùng ngoài vùng try-on (có giá trị 1 tại vùng ko cần try-on, là phần cần giữ nguyên)
        ...
        person_mask = 1 - parse_mask_total.copy()
